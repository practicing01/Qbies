...
%Size.X=(%Size.X*Qbies.Resolution.X)/%Ass.Optimal_Resolution.X;

%Size.Y=(%Size.Y*Qbies.Resolution.Y)/%Ass.Optimal_Resolution.Y;
...
%Size.X=(%Size.X*Qbies.Camera_Size.X)/Qbies.Resolution.X;

%Size.Y=(%Size.Y*Qbies.Camera_Size.Y)/Qbies.Resolution.Y;
...
%Vector_2D_Scaled.X-=Qbies.Resolution.X/2;//offset cus cam is from -50 to 50

%Vector_2D_Scaled.Y-=Qbies.Resolution.Y/2;//offset cus cam is from -30 to 30

%Vector_2D_Scaled.Y=-%Vector_2D_Scaled.Y;//flip cus -y is down and +y is up

%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*Qbies.Camera_Size.X)/Qbies.Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*Qbies.Camera_Size.Y)/Qbies.Resolution.Y;
...
%Vector_2D_Scaled.X=(%Vector_2D_Scaled.X*Qbies.Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D_Scaled.Y=(%Vector_2D_Scaled.Y*Qbies.Resolution.Y)/%Vector_2D_Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Qbies.Camera_Size.X)/Qbies.Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*Qbies.Camera_Size.Y)/Qbies.Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Qbies.Resolution.X)/%Vector_2D_Resolution.X;

%Vector_2D.Y=(%Vector_2D.Y*Qbies.Resolution.Y)/%Vector_2D_Resolution.Y;
...
%Vector_2D.X=(%Vector_2D.X*Qbies.Resolution.X)/Qbies.Camera_Size.X;

%Vector_2D.Y=(%Vector_2D.Y*Qbies.Resolution.Y)/Qbies.Camera_Size.Y;
