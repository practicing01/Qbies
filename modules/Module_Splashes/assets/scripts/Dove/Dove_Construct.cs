...
for (%x=0;%x<Scene_Qbies.getCount();%x++)
{

%Object=Scene_Qbies.getObject(%x);
...
Scene_Qbies.createDistanceJoint(%Dove_Head,%Dove_Body,
%Dove_Head.getLocalPoint(%Dove_Body.Position),"0 0",0.1,3,0.0,true);

Scene_Qbies.createDistanceJoint(%Dove_Leftwing,%Dove_Body,
%Dove_Leftwing.getLocalPoint(%Dove_Body.Position),"0 0",0.1,3,0.0,true);

Scene_Qbies.createDistanceJoint(%Dove_Leftleg,%Dove_Body,
%Dove_Leftleg.getLocalPoint(%Dove_Body.Position),"0 0",0.1,3,0.0,true);

Scene_Qbies.createDistanceJoint(%Dove_Rightwing,%Dove_Body,
%Dove_Rightwing.getLocalPoint(%Dove_Body.Position),"0 0",0.1,3,0.0,true);

Scene_Qbies.createDistanceJoint(%Dove_Rightleg,%Dove_Body,
